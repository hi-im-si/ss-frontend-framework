...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	<head>
		...
		<script>
			 ...
			 * Build: http://modernizr.com/download/#-touch-shiv-mq-cssclasses-addtest-teststyles-prefixes-load
			 */
			...
			Modernizr.load([
				...
				{
					load:[
						"assets/js/vendor/conditionizr.min.js",

						"assets/js/lib/imager.js",
						"assets/js/lib/magnific-popup.js",

						"assets/js/objects/radio-wrapper.js",
						"assets/js/objects/placeholder.js",
						"assets/js/objects/accordion.js",
						"assets/js/objects/forms.js",

						"assets/js/modules/console-log.js",
						"assets/js/modules/conditionizr-init.js",
			...
			/* Google analytics*/
	        !function(e,n,t,a,c,o,s){e.GoogleAnalyticsObject=c,e[c]=e[c]||function(){(e[c].q=e[c].q||[]).push(arguments)},e[c].l=1*new Date,o=n.createElement(t),s=n.getElementsByTagName(t)[0],o.async=1,o.src=a,s.parentNode.insertBefore(o,s)}(window,document,"script","//google-analytics.com/analytics.js","ga");ga('create','UA-XXXXXXX-X','auto');
	    </script>
	</head>


	<body id="home-page" data-page="home" itemscope itemtype="http://schema.org/WebPage">
